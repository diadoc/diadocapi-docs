...
-  :download:`XML-схема счета-фактуры (СФ) <../xsd/ON_SFAKT_1_897_01_05_02_01.xsd>`__; эта же схема описывает формат исправления СФ (ИСФ);

-  :download:`XML-схема корректировочного счета-фактуры (КСФ) <../xsd/ON_KORSFAKT_1_911_01_05_02_01.xsd>`__; эта же схема описывает формат исправления КСФ (ИКСФ);
