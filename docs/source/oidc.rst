...
В Диадоке авторизация по протоколу `OpenID Connect <https://openid.net/connect/>`__ происходит с помощью сервиса `OpenID Провайдер <https://developer.kontur.ru/Docs/html/schemes/index.html>`__ — аутентификационного сервера, который выдает ключ доступа к продукту —  авторизационный токен.
