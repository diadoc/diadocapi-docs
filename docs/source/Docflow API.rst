...
С помощью Docflow API можно получать из системы данные о документах и следить за происходящими в ящиках событиями (для отправки документов и работы с организациями можно воспользоваться `старой версией API <https://diadoc.kontur.ru/sdk/>`_).
