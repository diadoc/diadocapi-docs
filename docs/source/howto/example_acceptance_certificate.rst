...
Титул исполнителя можно отправить с помощью метода :doc:`../http/PostMessage`. 
...
Перед получением файла титула исполнителя найдите все входящие акты сверки, которые нужно обработать. Для этого используйте метод :doc:`../http/GetDocuments`:
...
--------------------------------------------------------------------------
Отправить титул заказчика акта сверки можно с помощью метода :doc:`../http/PostMessagePatch`. 
