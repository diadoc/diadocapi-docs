...
- У каждого документа можно отредактировать теги не более 10 раз (добавить новые, изменить или удалить существующие).
...
- При трансформации шаблона в документ теги будут скопированы.
