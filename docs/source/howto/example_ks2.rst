...
Файлы титулов акта о приемке выполненных работ КС-2, соответствущие `утвержденному формату <https://normativ.kontur.ru/document/last?moduleId=1&documentId=431929>`__, нужно сформировать в сторонней информационной системе. Генерация в АПИ Диадока недоступна.
