...
Чтобы обновить авторизационный токен ``access_token``, используйте ``refresh_token``, полученный вместе с ним при запросе. Для этого в интеграционном решении выолните запрос на Token Endpoint сервиса OpenID Провайдера.
