...
Если вы планируете перед отправкой отредактировать документ, используйте :doc:`настройки редактирования <editingsettings>`. Для этого в поле ``MessageToPost.DocumentAttachment.EditingSettingId`` укажите значение идентификатора настройки редактирования, полученного у вашего менеджера.
...
- нельзя изменить содержимое документа и реквизиты получателя, за исключением документов с :doc:`настройками редактирования <editingsettings>`.
...
.. table:: Различия черновика, шаблона и исходящего неотправленного документа
	...
	| отправкой                       | :doc:`настройки редактирования <editingsettings>`   |                                       | :doc:`настройки редактирования <editingsettings>`  |
	+---------------------------------+-----------------------------------------------------+---------------------------------------+----------------------------------------------------+
