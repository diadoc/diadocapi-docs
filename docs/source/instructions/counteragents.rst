...
Диадок предоставляет возможность работать с группами контрагентов, а так же получать информацию о событиях, которые происходят в отношениях с контрагентами:
