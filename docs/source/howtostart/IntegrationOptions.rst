...
- `SDK Диадока <https://diadoc.kontur.ru/sdk/>`__ — набор готовых инструментов для разработки клиентских приложений. Включает в себя решения на языках: `C# <https://github.com/diadoc/diadocsdk-csharp>`__, `C++ <https://github.com/diadoc/diadocsdk-cpp>`__, `Java <https://github.com/diadoc/diadocsdk-java>`__. Для интеграторов, ведущих разработку в стеке технологий Microsoft, доступна клиентская :doc:`библиотека .NET/COM <DiadocApiDll>`.
