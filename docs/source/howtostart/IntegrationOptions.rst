...
Но этот способ имеет свои недостатки: все сложности взаимодействия клиентской части с API через HTTP разработчик должен взять на себя.
...
Чтобы облегчить сложности взаимодействия клиентской части с HTTP API, разработаны некоторые готовые решения, которые разработчики могут использовать в своих приложениях.
