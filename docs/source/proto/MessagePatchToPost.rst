...
- ``CustomDataPatches`` — список операций по изменению пользовательских данных (:doc:`тегов <../howto/tags>`) у документов в исходном сообщении. Представлены структурой :doc:`CustomDataPatch`. Максимальное количество патчей — 15.
