...
*CloudSignRequest* - массив файлов для подписания Контур.Сертификатом.

*CloudSignFile* - файл для подписания:

-  *FileName* - имя файла, который пользователь увидит в отчете об использовании своего Контур.Сертификата
