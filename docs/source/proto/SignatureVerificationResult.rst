...
Структура представляет протокол проверки ЭП, формируемый в процессе доставки документа.

-  *IsValid* - статус проверки подписи (соответствует ли подпись подписываемому контенту).
