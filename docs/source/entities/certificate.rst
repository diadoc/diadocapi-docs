...
Работать в Диадоке можно только с сертификатами КЭП. Исключение составляют иностранные организации, которые могут работать только с сертификатами НЭП, выданными удостоверяющим центром СКБ Контур.
