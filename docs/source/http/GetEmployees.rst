...
.. http:get:: /GetEmployees
	...
	:queryparam page: номер страницы, начиная с 1. Необязатеьный параметр, по умолчанию равен ``1``.
	:queryparam count: количество сотрудников на странице, от 1 до 50. Необязатеьный параметр, по умолчанию равен ``50``.
