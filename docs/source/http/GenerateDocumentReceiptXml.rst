...
При использовании данного метода в извещении не формируется элемент *ДанПолучДок*. Для формирования данных о полученном документе следует использовать метод :doc:`GenerateInvoiceDocumentReceiptXml <../GenerateInvoiceDocumentReceiptXml>
