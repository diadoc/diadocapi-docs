...
В теле ответа содержится информация о документе с идентификатором entityId из сообщения с идентификатором messageId в ящике boxId. Эта информация выдается в виде сериализованной структуры данных :doc:`../proto/Document`. Содержимое документа можно прочитать из поля Document.Content (см. описание структуры :doc:`../proto/Content`). Формат содержимого зависит от типа документа (см. описание возможных форматов в статье о структуре :doc:`Entity <../proto/Entity message>`). Содержимое документа также всегда можно получить при помощи метода :doc:`GetEntityContent`.
