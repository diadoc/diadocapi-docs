...
Метод ``AcquireCounteragent`` отправляет :doc:`контрагенту <../entities/counteragent>` приглашение к партнерским отношениям. С помощью этого метода можно добавить организацию в :doc:`список активных контрагентов <../Counteragents>`.
