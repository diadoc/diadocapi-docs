...
.. http:get:: /GetTemplate
	...
	:queryparam entityId: идентификатор документа из сообщения. Параметр может отсутствовать; если указан, то возвращаются только сущности, связанные с данным документом.
