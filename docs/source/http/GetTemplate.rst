...
.. http:get:: /GetTemplate
	...
	:queryparam entityId: идентификатор документа из сообщения. Необязатеьный параметр; если указан, то возвращаются только сущности, связанные с данным документом.
