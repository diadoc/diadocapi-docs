...
Файл с уведомлением изготавливается в соответствии с `XML-схемой <https://diadoc.kontur.ru/sdk/xsd/DP_UVUTOCH_1_985_00_01_01_02.xsd>`__, которой должны удовлетворять уведомления об уточнении, предусмотренные порядком обмена электронными счетами-фактурами. Имя файла с уведомлением (которое также диктует приказ ФНС) передается в стандартном HTTP-заголовке Content-Disposition.
