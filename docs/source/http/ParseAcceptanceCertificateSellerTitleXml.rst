...
Файл изготавливается в соответствии с :download:`XML-схемой <../xsd/DP_IAKTPRM_1_987_00_05_01_02.xsd>`__, которой должны удовлетворять титулы исполнителя формализованных XML актов, согласно приказу ФНС.
