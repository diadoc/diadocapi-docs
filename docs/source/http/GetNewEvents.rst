...
Если пользователь не имеет доступа ко всем документам организации, то нужно указать departmentId. Задать можно любое подразделение, к документам которого пользователь имеет доступ.
