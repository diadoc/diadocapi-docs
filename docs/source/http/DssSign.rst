...
Метод возвращает идентификатор операции ``taskId`` в структуре :doc:`../proto/AsyncMethodResult`. По этому идентификатору с помощью метода :doc:`DssSignResult` можно узнать результат обработки запроса.
