...
.. http:get:: /GetOrganization
	...
	:queryparam orgId: идентификатор организации. Необязатеьный параметр.
	:queryparam boxId: идентификатор ящика организации. Необязатеьный параметр.
	:queryparam fnsParticipantId: идентификатор участника электронного документооборота. Необязатеьный параметр.
	:queryparam inn: ИНН организации. Необязатеьный параметр.
	:queryparam kpp: КПП организации. Необязатеьный параметр.
