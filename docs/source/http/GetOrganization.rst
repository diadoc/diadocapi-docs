...
.. http:get:: /GetOrganization
	...
	:queryparam orgId: идентификатор организации; может отсутствовать.
	:queryparam boxId: идентификатор ящика организации.; может отсутствовать.
	:queryparam fnsParticipantId: идентификатор участника электронного документооборота; может отсутствовать.
	:queryparam inn: ИНН организации; может отсутствовать.
	:queryparam kpp: КПП организации; может отсутствовать.
