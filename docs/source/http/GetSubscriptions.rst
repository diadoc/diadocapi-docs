...
.. http:get:: /GetSubscriptions
	...
	:response Body: Тело ответа содержит информацию о подписках сотрудника организации на почтовые уведомления, представленную структурой :doc:`../proto/EmployeeSubscriptions`.