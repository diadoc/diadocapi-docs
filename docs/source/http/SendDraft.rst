...
.. http:post:: /SendDraft
	...
	:queryparam operationId: уникальный идентификатор операции. Необязательный параметр. По умолчанию имеет значение MD5-хэш тела запроса.
...
*Другие методы для работы с черновиками:*
	- :doc:`RecycleDraft` — удаляет не утилизированные черновики.
	- :doc:`PostMessage` — создает черновик.