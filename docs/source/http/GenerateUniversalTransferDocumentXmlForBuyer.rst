...
В теле запроса должны содержаться данные для изготовления документов в формате "УПД", в виде сериализованной структуры :doc:`../proto/UniversalTransferDocumentBuyerTitleInfo'.
