...
-  *token*: строка, полученная в результате расшифровки тела ответа при двухфазной аутентификации по сертификату, в формате base64 (см. :doc:`Authenticate v3 <./Authenticate>`):
