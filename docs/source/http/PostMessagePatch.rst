...
.. http:post:: /V3/PostMessagePatch
	...
	:statuscode 409: осуществляется попытка отправить дубликат или запрещен прием документов от контрагентов согласно свойству ``Sociability`` в структуре :doc:`../proto/Organization`, или в сутки отправлено больше трех невалидных подписей для одной :doc:`сущности <../entities/entity>`.
