...
.. http:post:: /PostTemplatePatch
    ...
    :query templateId: идентификатор шаблона
    ...
    :body: содержимое, сериализованное в протобуфер :doc:`../proto/TemplatePatchToPost`
    ...
    :statuscode 403: доступ запрещен. Возвращается, если: доступ к ящику с предоставленным авторизационным токеном запрещен; нет доступа к шаблону; отсутствуют права на создание/редактирование документов
    :statuscode 404: шаблон документа не найден
