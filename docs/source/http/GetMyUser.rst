...
.. http:get:: /GetMyUser
	...
	:response Body: Тело ответа содержит информацию о текущем авторизованном пользователе, от имени которого вызывается метод, представленную структурой :doc:`../proto/obsolete/User`.