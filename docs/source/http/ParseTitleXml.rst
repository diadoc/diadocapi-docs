...
- необходимо данные из документа в Диадоке записать в соответствующие поля в учетной системе
- необходимо использовать данные 1 титула при генерации 2 титула
