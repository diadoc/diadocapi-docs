Подпись CloudCrypt сертификатом
===============================

Подписание CloudCrypt сертификатом ЭП осуществляется в два этапа.
...
В результате успешного завершения этого этапа, вы получите token (идентификатор операции с CloudCrypt сертификатом ЭП), а на телефон пользователя будет отправлено SMS-сообщение с кодом подтверждения операции.
