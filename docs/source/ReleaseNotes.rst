...
- Обновилась версия методов :doc:`http/GetNewEvents` и :doc:`http/GetMessage`. Новая версия возвращает эвенты по шаблонам :doc:`proto/Message` и :doc:`proto/MessagePatch`
