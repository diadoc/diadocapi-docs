...
Добавлена поддержка подписаня сертификатми МЭП в метод :doc:`http/DssSign`
...
26.12.2019
----------
`Java 3.0.0 <https://github.com/diadoc/diadocsdk-java/releases/tag/versions%2F3.0.0>`__


- Произошёл глобальный рефакторинг Java SDK, в котором внутреннее устройство библиотеки было переработано, обновились зависимости и произошли некоторые breaking changes.
...
- Появились доменные клиенты, обратиться к которым можно через корневой объект DiadocApi. Методы были перемещены по соответствующим доменным клиентам, а в старых методах были сделаны перевызовы. Все старые методы помечены @Deprecated, и будут удалены в ближайшее время.
- Breaking changes:
    - Тип GeneratedFile был перемещён в пакет Diadoc.Api.httpClient;
    - Тип DiadocErrorException был переименоват в DiadocException
    - Тип DocumentsFilter был перемещён в пакет Diadoc.Api.document, и был изменён его интерфейс. Убрали публичные поля, на их месте появились fluent setters
