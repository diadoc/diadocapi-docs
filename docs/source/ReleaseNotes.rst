...
- Расширили структуру :doc:`CertificateInfoV2 <proto/CertificateList>`, чтобы предоставить возможность отличить тип сертификата:

	- добавили поле ``Usages``, которое хранит тип сертификата,
	- добавили поле ``DssType``, которое хранит тип DSS-сертификата.
