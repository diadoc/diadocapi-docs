...
В появилась возможность работать с новыми типами документов УПД и УКД, в связи с чем в документации появились новые разделы:

-  Добавлен раздел, описывающий :doc:`документооборот УПД/УКД <UtdDocflow.rst>`
   
-  Добавлен раздел, описывающий :doc:`работу с УПД <API_UniversalTransferDocument.rst>`
