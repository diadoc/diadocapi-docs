...
Появилась возможность оределить версию XSD схемы, в соответствии которой был отправлен документ.

В структурах данных :doc:`Entity <proto/Document>` и :doc:`Document <proto/Entity message>` появилось поле *AttachmentVersion*. Значения, возращаемые в данном поле показываю версию XSD схемы. Версия XSD возвращается для документов, сформированных в соотвествии призам ФНС №155 от 24 марта 2016 и №189 от 13 апреля 2016. В дальнейшем планируется расширение перечня возвращаемых значений.
