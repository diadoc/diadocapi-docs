...
Также библиотека DiadocApi.dll включает в себя объект ComDiadocApi, представляющий собой обертку объекта DiadocApi, доступную для обращений через инфраструктуру `COM <https://msdn.microsoft.com/en-us/library/ms680573.aspx>`__.
