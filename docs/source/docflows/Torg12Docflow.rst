...
Документы в сообщениии имеют :doc:`тип сущности <../proto/Entity message>` ``EntityType = Attachment``. Для документов, возникающих в ходе документооборота электронных накладных, в Диадоке зарезервированы следующие типы вложения ``AttachmentType``:
