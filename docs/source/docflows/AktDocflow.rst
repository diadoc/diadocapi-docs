...
.. csv-table:: Соответствие формата актов и AttachmentVersion
   ...
   "Титул исполнителя", "Приказ №820", ":doc:`../http/GenerateTitleXml`", "``documentVersion = utd820_05_01_01``"
   "Титул заказчика", "Приказ №820", ":doc:`../http/GenerateTitleXml`", "``documentVersion = utd820_05_01_01``"
