...
Документы в сообщениии имеют :doc:`тип сущности <../proto/Entity message>` ``EntityType = Attachment``. Для документов, возникающих в ходе документооборота УПД с функцией СЧФ, в Диадоке зарезервированы следующие типы вложения ``AttachmentType``:
