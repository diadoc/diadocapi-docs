...
Шаблоны могут быть одноразовыми и многоразовыми.  Одноразовый шаблон - получатель может создать документы на основе шаблона только один раз. Многоразовый - из одного шаблона контрагент может создать неограниченное количество документов.
