...
- В поле ``TemplateToPost.TemplateDocumentAttachment.EditingSettingId`` укажите значение идентификатора настройки редактирования, полученный у вашего менеджера.
