...
.. csv-table:: Соответствие типов документов и форматов документов
   ...
   - приказ №820", "- СЧФ, ДОП, СЧФДОП
   - СЧФ, ДОП, СЧФДОП", "УПД"
   "УПД", "UniversalTransferDocumentRevision", "- приказ №155
   
   - приказ №820", "- СЧФ, ДОП, СЧФДОП
   - СЧФ, ДОП, СЧФДОП", "УПД"
   "УКД", "UniversalCorrectionDocument", "- приказ №189", "- КСЧФ, ДИС, КСЧФДИС
   - КСЧФ, ДИС, КСЧФДИС", "УКД"
