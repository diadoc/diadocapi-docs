...
Для подписания DSS-сертификатом нужно вызвать метод :doc:`http/DssSign` и дождаться успешного завершения подписания, периодически вызывая метод :doc:`http/DssSignResult`.
